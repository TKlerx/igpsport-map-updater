...
def package_name(input_maps, output_maps, label=None):
    ...
    return f"IGPSport300-800-{label_part}.zip"
...
def build_manifest(input_maps, output_maps, package_filename):
...
def create_package(input_maps, output_maps, readme_path, package_path):
    """Create the ZIP package."""
    manifest = build_manifest(input_maps, output_maps, package_path.name)
...
def main():
    ...
    filename = args.name or package_name(input_maps, output_maps, args.label)
    ...
    create_package(input_maps, output_maps, readme_path, package_path)
